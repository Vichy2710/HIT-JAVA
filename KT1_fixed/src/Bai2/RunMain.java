        ...
        while (choose != 7){
            ...
            switch (choose){
                case 1:
                    ...
                    if(books.stream().anyMatch(x->x.getId().equals(aNewOne.getId()))){
                        ...
                        System.out.print("Nhap tac gia: "); aNewOne.setPublisher(input.nextLine());
                        books.add(aNewOne);
                    }
                    break;
                case 2:
                        ...
                        if (books.get(i).getId().compareTo(idForEditing)==0){
                            ...
                            switch (numOfAtt){
                                ...
                                case 5:
                                    ...
                                    break;
                                case 6:
                                    System.out.print("Nhap tac gia: "); books.get(i).setPublisher(input.nextLine());
...
//                    for (int i=0;i<books.size();i++){
//                        if(books.get(i).getId().equals(delID)){
//                            delPos=i;
//                        }
//                    }
                    books.removeIf(x->x.getId().equals(delID));
                    break;
                case 4:
